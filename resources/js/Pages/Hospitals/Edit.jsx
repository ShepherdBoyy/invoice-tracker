...
export default function Edit({ setOpenEditModal, hospital, setShowToast, setSuccessMessage, areas }) {
            ...
            <div className="modal-box">
                ...
                >
                    ...
                    <div className="flex flex-col gap-2 mt-8">
                        <div className="flex justify-between">
                            <label htmlFor="hospital_number" className="text-sm">Hospital No.</label>
                    ...
                    <div className="flex flex-col gap-2 mt-8">
                        <div className="flex justify-between">
                            <label htmlFor="hospital_name" className="text-sm">Hospital Name</label>
                            {error.hospital_name && (
                                <span className="text-red-500 text-sm">
                                    {error.hospital_name}
                                </span>
