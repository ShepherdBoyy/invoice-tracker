...
export default function DeleteHospitalModal({ setOpenDeleteModal, hospital, setShowToast, setSuccessMessage }) {
    return (
                        ...
                        onClick={() =>
                            router.delete(`/hospitals/delete/${hospital.id}`, {
                                onSuccess: () => {
                                    ...
                                    setSuccessMessage(`${hospital.hospital_name} deleted successfully`);
                                },
                            })
                        }
                    >
